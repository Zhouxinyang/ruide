...
<body>
	...
	<div class="body">
	    ...
	    <div class="col-main">
			...
			<div class="content-container"><div id="toolbar" class="toolbar" data-module="/admin/balance"><?php \Common\Common\Auth::get()->showTollbar('admin', 'balance', 'stat') ?><form id="order_search" class="form-horizontal">
...
<table id="table" data-toggle="gridview" class="table" data-url="<?php echo __ACTION__; ?>" data-toolbar="#toolbar"  data-show-columns="true"
 data-side-pagination="client" data-page-size="All">
    <thead>
        <tr>
            <th data-field="type_name" >付款类型</th>
            <th data-field="type" >付款类型标记</th>
            <th data-field="bp" data-formatter="fomat_status">收支</th>
            <th data-field="count" >记录总数</th>
            <th data-field="money" >金额总计</th>
        </tr>
    </thead>
</table>
