...
<body>
	...
	<div class="body">
	    ...
	    <div class="col-main">
			...
			<div class="content-container"><form class="form-horizontal text-center" method="post" action="<?php echo __ACTION__; ?>" enctype="multipart/form-data" target="_balank">
	<div class="" style="background-color:#fff;padding: 5px 15px;">
	  <input type="file" name="file_stu" title="请选择excel文件"/>
...
<table class="table" style="background-color:#fff;">
	...
	<?php if(is_array($express_list)): foreach($express_list as $key=>$item): ?><tr>
...
$(function(){
	$('input[name="file_stu"]').change(function(event) {
		var exlName = $(this).val()
		if ( exlName == '' ) {
			exlName = '请选择'
		};
		$(this).closest('label').find('span').text(exlName);
	});
});
</script></div>
	    </div>
