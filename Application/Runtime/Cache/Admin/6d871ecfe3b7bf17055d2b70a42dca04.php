...
<body>
	...
	<div class="body">
	    ...
	    <div class="col-main">
			...
			<div class="content-container"> <div id="toolbar" class="toolbar" data-module="/admin/level"><?php \Common\Common\Auth::get()->showTollbar('admin', 'level', 'index') ?><form id="level_search" class="form-horizontal">
		<div class="clearfix">
			<?php if($access == true): ?><div class="filter-groups">
...
$(function(){
	$('#table').on('printdetail',function(e, gridview ,params){
		...
		var url = '<?php echo __CONTROLLER__; ?>/printdetail?';
		...
		params.url = '<?php echo __CONTROLLER__; ?>/adjust_level';
	});
});
