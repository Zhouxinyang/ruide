...
<body>
	...
	<div class="body">
	    ...
	    <div class="col-main">
			...
			<div class="content-container"><div id="toolbar" class="toolbar" data-module="/admin/ruide"><?php \Common\Common\Auth::get()->showTollbar('admin', 'ruide', 'check') ?><input type="text" class="hidden" id='id' value="<?php echo ($id); ?>"></div>

<table id="table" data-toggle="gridview" class="table table-hover" data-url="<?php echo __ACTION__; ?>?id=<?php echo ($id); ?>" data-toolbar="#toolbar" data-page-size="20" data-page-list="[5, 10, 25, 50, All]">
    <thead>
    <tr>
        <th data-width="40" data-align="center" data-checkbox="true"></th>
        <th data-field="product" data-width="200">产品</th>
        <th data-field="position" data-width="200">职位</th>
        <th data-width="100" data-field="show" data-formatter="formatter_img">授权书展示</th>
    </tr>
    </thead>
</table>
<script type="text/javascript">
    ...
    $(function() {
        $('#table').on('add_sq',function (e, gridview, params) {
            params.url += '?uid=' + $('#id').val();
        });
    });
