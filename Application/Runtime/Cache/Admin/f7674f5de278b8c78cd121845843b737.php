...
<body>
	...
	<div class="body">
	    ...
	    <div class="col-main">
			...
			<div class="content-container"><div id="toolbar" class="toolbar" data-module="/admin/reply"><?php \Common\Common\Auth::get()->showTollbar('admin', 'reply', 'index') ?></div>
...
function formatterContent(contents, row, index){
	...
	for(var i=0; i<contents.length; i++){
		...
		case 'news':
			html += '图　　文</span> ' + contents[i].title;
			break;
		case 'senior':
